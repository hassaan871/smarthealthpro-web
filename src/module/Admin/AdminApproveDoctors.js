...
const AdminApproveDoctors = () => {
  ...
  const confirmDeleteDoctor = () => {
    // Here you would typically call an API to delete/reject the doctor
    console.log(`Declining doctor approval: ${doctorToDelete.fullName}`);
    setDoctorToDelete(null);
  };

  const confirmApproveDoctor = () => {
    // Here you would typically call an API to approve the doctor
  ...
  return (
    <div className="container-fluid bg-dark text-white py-5" style={{ minHeight: "100vh" }}>
      <div className="container">
        <h1 className="text-center mb-5 text-primary">Doctor Approval Dashboard</h1>
          ...
          <div className="col-md-8 offset-md-2">
            <div className="card bg-secondary">
              <div className="card-header bg-dark text-primary">
                <h3 className="mb-0">Pending Approval Requests</h3>
              </div>
        ...
        {doctorToApprove && (
          <div className="modal show d-block" tabIndex="-1" style={{ backgroundColor: "rgba(0,0,0,0.7)", position: "fixed", top: 0, left: 0, width: "100%", height: "100%", zIndex: 1051, overflowY: "auto" }}>
            <div className="modal-dialog">
              <div className="modal-content bg-dark text-white">
                <div className="modal-header border-bottom-0">
                  <h5 className="modal-title text-success">Confirm Doctor Approval</h5>
                  <button 
                    type="button" 
                    className="btn-close btn-close-white" 
                ...
                <div className="modal-body">
                  <p>Are you sure you want to approve the following doctor?</p>
                  <div className="alert alert-success">
                    <strong>Name:</strong> {doctorToApprove.fullName}<br />
                    <strong>Specialization:</strong> {doctorToApprove.specialization}<br />
                    <strong>Rating:</strong> {doctorToApprove.rating}/5.0
                  </div>
                  <p className="text-muted">This will grant the doctor access to the platform.</p>
                </div>
                <div className="modal-footer border-top-0">
                  <button 
                    type="button" 
        ...
        {/* Delete/Decline Confirmation Modal */}
        {doctorToDelete && (
          <div className="modal show d-block" tabIndex="-1" style={{ backgroundColor: "rgba(0,0,0,0.7)", position: "fixed", top: 0, left: 0, width: "100%", height: "100%", zIndex: 1051, overflowY: "auto" }}>
            <div className="modal-dialog">
              <div className="modal-content bg-dark text-white">
                <div className="modal-header border-bottom-0">
                  <h5 className="modal-title text-danger">Confirm Approval Decline</h5>
                  <button 
                    type="button" 
                    className="btn-close btn-close-white" 
                ...
                <div className="modal-body">
                  <p>Are you sure you want to decline the approval of the following doctor?</p>
